        ...
        <div class="form-group">
            ...
            <form align="left"  action="ControladorPlantilla" method="POST">
                ...
                <br>
                 ...
                 <input class="form-control" placeholder="id plantilla"  type="text" name="txtid" value="${plantilla.getId()}">
               <br>
              ID CATEGORIA:
               <input   class="form-control" placeholder=" id categoria"  type="text" name="txtidcategoria"  value="${plantilla.getId_cate()} ">
               <br>
               NOMBRE:
