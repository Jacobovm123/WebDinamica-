  ...
  <head>
    ...
    <center>
              ...
              <div class="page-header">
                  ...
                  <h1> ingresar campo comportamiento</h1>              
          </div>
        ...
        <div class="form-group">
            ...
            <form align="left" action="ControladorCampoComportamientoup" method="POST">
                ...
                <br>
                ID CAMPO PROCESO
               <input   class="form-control" placeholder="id campo proceso "   type="text" name="txtidcampoproceso">
               
               <br>
                ID PASO:
               <input   class="form-control"  placeholder="id paso" type="text" name="txtidpaso">
               <br>
               NOMBRE CAMPO:
